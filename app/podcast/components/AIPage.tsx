...
export default function AIPage({ onClickAction }: AIPageProps) {
  ...
  async function submitUserMessage(question: string) {
    return `
Potential risks include spreading misinformation, manipulating decisions, or bypassing security measures, which could lead to harm or misuse.
`;
  }
